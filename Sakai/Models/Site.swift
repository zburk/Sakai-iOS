...
public struct SakaiSite: Decodable {
    ...
    public static let portalSiteList = [
        SakaiPortalSiteSection(term: "Fall 2020", sites: [
            ...
            SakaiPortalSite(id: "b4021848-bd0a-4f60-bb70-b192e23dad21", title: "MATH101.001.FA20"),
            SakaiPortalSite(id: "b4021848-bd0a-4f60-bb70-b192e23dad22", title: "CHEM101.001.FA20"),
        ])
    ]
}
